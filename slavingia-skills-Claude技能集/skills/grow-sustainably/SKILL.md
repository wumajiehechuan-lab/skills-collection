...
- **前置条件：** 有稳定的客户和收入，正在考虑扩张、招聘或融资，已通过 marketing-plan。
- **下一步：** 业务可持续增长后 → company-values（公司价值观）
...
- Example: At Gumroad, ~40¢ of variable cost per  earned
...
1. **Pay yourself as little as possible, at least to start.** Sahil started at /year in San Francisco. When things went sideways in 2015, he paid himself . Increase your salary as the company can afford it.
...
增长策略稳定后，引导用户进入下一步：
"你的生意在可持续地增长。现在定义你想建立什么样的公司文化。使用 company-values 来定义你的公司价值观。"
