...
**这是极简创业九步流程的第 3a 步（构建阶段的前半部分）。**

- **前置条件：** 已通过 alidate-idea 验证了想法。
- **下一步：** 手动流程跑通后 → mvp（产品化）
- **与 MVP 的关系：** 流程化是 MVP 的前置步骤。先手动交付、流程文档化，再产品化。
...
> "There is a massive difference between free and ."

The zero price effect means free users give you zero signal. Charging even  proves someone values what you do.
...
手动流程跑通后，引导用户进入下一步：
"你已经手动跑通了流程，客户愿意付钱。现在可以把重复劳动产品化了——但只做最必要的部分。使用 mvp 来规划你的最小可行产品。"
