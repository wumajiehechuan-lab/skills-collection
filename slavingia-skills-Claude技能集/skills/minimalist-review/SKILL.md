...
**这是极简创业九步流程的第 9 步——也是唯一一个可以在任何阶段使用的技能。**

- **前置条件：** 无。极简审查随时可用，无论你在哪个阶段。
- **用途：** 对任何商业决策进行直觉检验，确保你始终遵循极简主义原则。
- **与其他技能的关系：** 极简审查贯穿整个流程。你可以在发现社区后审查你的社区选择，在定价后审查你的定价策略，在任何重要决策时使用它。
